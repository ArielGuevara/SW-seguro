...
public class SocioServiceImpl implements SocioService {
    ...
    public void eliminarSocio(UUID id) {
        ...
        // PASO 1: Validar con el otro microservicio
        boolean tieneCuentas = cuentaIntegrationService.tieneCuentasActivas(id);

        if (tieneCuentas) {
            throw new IllegalStateException("No se puede eliminar al socio porque tiene cuentas activas o el servicio de cuentas no está disponible.");
        }

        // PASO 2: Eliminar si pasa la validación
